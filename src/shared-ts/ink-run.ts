...
const STORY_TAGS = JSON.stringify({"inkVersion":21,"root":[["#","^title: The test story","/#","#","^roles: cat=Jimy's cat, dad=Jimy's super cool dad","/#","^Early in the morning, sunday ","#","^narative","/#","\n","^dad: Hey Jimy, how ru ?","\n","^Jimy: Fine and you ?","\n",["ev",{"^->":"0.15.$r1"},{"temp=":"$r"},"str",{"->":".^.s"},[{"#n":"$r1"}],"/str","str","^Great!","/str","/ev",{"*":"0.c-0","flg":22},{"s":["#","^enjoy ","/#",{"->":"$r","var":true},null]}],["ev",{"^->":"0.16.$r1"},{"temp=":"$r"},"str",{"->":".^.s"},[{"#n":"$r1"}],"/str","str","^Amazing!","/str","/ev",{"*":"0.c-1","flg":22},{"s":["#","^enjoy++ ","/#",{"->":"$r","var":true},null]}],{"c-0":["ev",{"^->":"0.c-0.$r2"},"/ev",{"temp=":"$r"},{"->":"0.15.s"},[{"#n":"$r2"}],"^ dad: Great!","\n",{"->":"0.g-0"},{"#f":5}],"c-1":["ev",{"^->":"0.c-1.$r2"},"/ev",{"temp=":"$r"},{"->":"0.16.s"},[{"#n":"$r2"}],"^ dad: Amazingly!","\n",{"->":"0.g-0"},{"#f":5}],"g-0":["^Jimy: Why are you up so early? ","#","^happy","/#","\n","ev","str","^Go to movie theater","/str","/ev",{"*":".^.c-2","flg":20},"ev","str","^Go to amusement park","/str","/ev",{"*":".^.c-3","flg":20},{"c-2":["^ Because today, we are going to see Shark2!","\n",{"->":"0.g-1"},{"#f":5}],"c-3":["^ Because Puy du Fou open at nine!","\n",{"->":"0.g-1"},{"#f":5}],"#f":5}],"g-1":["^Jimy: YEAHHHH","\n","end",["done",{"#f":5,"#n":"g-2"}],{"#f":5}]}],"done",{"#f":1}],"listDefs":{}});
